...
class ExhaustiveExplorer(ExplorationTechnique):
    """
    ...
    """
    def __init__(self, find=None, avoid=None, find_stash='found', avoid_stash='avoid', cfg=None, avoid_priority=False):
    ...
    def complete(self, simgr):
        return False  # hack for letting the exploration continue until all paths are tried
